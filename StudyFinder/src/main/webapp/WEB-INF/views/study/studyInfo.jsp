										...
										<div class="card-body">
											<form action="<c:url value="/study/createStudy"/>"
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control form-control-line"
															name="auth_userid" id="userid" value="${study.auth_userid}"
															readonly="readonly">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">${study.limit_time}이후 결석</div>
												</div>
											</form>
											<hr>
											<c:if test="${sessionScope.userid != study.auth_userid}">
												<div class="form-group row">
													...
													<div class="col-sm-10">
														...
														<input type="button" class="btn btn-secondary" value="신청">
													</div>
												</div>
											</c:if>
											<div class="form-group row">
												<div class="col-md-12 text-right">
													<c:if test="${sessionScope.userid == study.auth_userid}">
														<input type="button" id="sSubmit" class="btn btn-info"
															value="글수정">
														<a
															href="<c:url value="/study/deletestudy?study_no=${study.study_no}"/>"><input
															type="button" class="btn btn-dark" value="글삭제"></a>
													</c:if>
