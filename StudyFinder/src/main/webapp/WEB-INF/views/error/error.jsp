	...
	<div class="main-wrapper">
		...
		<div class="error-box">
			<div class="error-body text-center">
				<h1 class="error-title text-danger">예외발생</h1>
				<h3 class="text-uppercase error-subtitle">${msg}</h3>
				<p class="text-muted m-t-30 m-b-30">안 생겼으면 좋았겠습니다만,,</p>
				<a href="<c:url value="/"/>"
